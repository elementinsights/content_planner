...
export interface ScoringWeights {
  ...
  priority: { noBacklinkOpportunity: number; demand: number; trafficPotential: number; businessValue: number; clusterImportance: number; internalLinkValue: number; promotionValue: number; clickResilience: number };
...
export const DEFAULT_WEIGHTS: ScoringWeights = {
  ...
  priority: { noBacklinkOpportunity: 0.26, demand: 0.18, trafficPotential: 0.16, businessValue: 0.16, clusterImportance: 0.1, internalLinkValue: 0.12, promotionValue: 0.06, clickResilience: 0.12 },
